...
class FileOutput(tk.Frame):
    def __init__(self, *args, file_output_handler, file_output_title, file_output_dialog_props = {}, **kwargs):
        super().__init__(*args, **kwargs)
        
        self.file_output_handler = file_output_handler
        self.picked_file_path_string_var = tk.StringVar()
        self.file_output_dialog_props = file_output_dialog_props
    ...
    def handle_pick(self):
        file_path = tk.filedialog.asksaveasfilename(**self.file_output_dialog_props)
